...
const nextConfig: NextConfig = {
  // popbill SDK는 순수 Node.js CJS 패키지라 번들링 대상에서 빼고 네이티브 require를
  // 쓰게 한다(2026-09-22) — 실제 원인 진단·수정은 popbill/client.ts 쪽 주석 참고
  // (`this` 기반 캐싱 패턴이 Turbopack의 ESM 네임스페이스 인터롭과 충돌).
